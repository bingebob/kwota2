...
class PixelCanvas extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (radioInput) {
            radioInput.addEventListener('change', () => this.handleSelectionChange());
        }
    }
    ...
    disconnectedCallback() {
        ...
        // Remove radio button change listener
        const radioInput = this._parent.querySelector('input[type="radio"]');
        if (radioInput) {
            radioInput.removeEventListener('change', () => this.handleSelectionChange());
        }
    }
